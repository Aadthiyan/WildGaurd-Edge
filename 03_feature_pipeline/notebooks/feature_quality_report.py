...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--audio-dir", type=Path, default=Path("02_dataset/processed/cleaned_audio"), help="Directory with audio .npy.")
    parser.add_argument("--sensor-dir", type=Path, default=Path("02_dataset/processed/cleaned_sensor"), help="Directory with sensor parquet.")

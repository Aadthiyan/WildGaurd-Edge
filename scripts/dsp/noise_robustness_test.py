...
Example:
python scripts/dsp/noise_robustness_test.py \
    --config edge_impulse/dsp_pipeline.json \
    --audio-dir data/processed/audio \
    --snr-list 0 5 10 \
    --report artifacts/week1/feature_previews/noise_robustness.json
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--audio-dir", type=Path, default=Path("data/processed/audio"), help="Directory with normalized audio .npy files.")

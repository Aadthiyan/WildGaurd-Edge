...
MANIFEST_PATH_DEFAULT = Path("metadata/dataset_manifest.json")
LABEL_FILES = {
    "audio": Path("metadata/labels/audio_event_annotations.csv"),
    "sensor": Path("metadata/labels/sensor_segment_annotations.csv"),
}
